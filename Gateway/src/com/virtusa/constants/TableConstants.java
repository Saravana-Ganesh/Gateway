...
public class TableConstants {
	 //Table Constants LEGEND
	 public static final String LEGEND  ="Legend"; //Table name
	 
	//Table Constants USER_PROFILE
	 public static final String USER_PROFILE  ="UserProfile"; //Table name
